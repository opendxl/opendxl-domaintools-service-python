...
RELEASE_NAME = "dxldomaintoolsservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxldomaintoolsservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxldomaintoolsservice")])
...
print("\nRemoving dxldomaintoolsservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxldomaintoolsservice.egg-info"))
